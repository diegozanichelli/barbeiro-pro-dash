  ...
  return (
    <ScaledSlide>
      <div className="w-full h-full flex flex-col px-32 py-16">
        <p className="text-2xl font-mono uppercase tracking-[0.3em] text-primary/80 mb-4">Ranking</p>
        <h2 className="text-6xl font-bold mb-6">Top 10 barbeiros</h2>
        <div className="rounded-3xl border border-border bg-card/60 overflow-hidden flex-1 min-h-0">
          <div className="grid grid-cols-[60px_2fr_1.5fr_1fr_1fr_1fr] gap-4 px-6 py-3 border-b border-border bg-muted/30 text-lg font-semibold uppercase tracking-wider text-muted-foreground">
          ...
          {rows.map((r, i) => (
            <div key={r.barber_id} className="grid grid-cols-[60px_2fr_1.5fr_1fr_1fr_1fr] gap-4 px-6 py-3 items-center text-2xl border-b border-border/30 last:border-0">
