...
export default function IndividualEvolutionSlide({ data }: { data: MonthlyPresentationData }) {
  const rows = (data.individual_evolution ?? []).slice(0, 10);
  return (
    <ScaledSlide>
      <div className="w-full h-full flex flex-col px-32 py-20">
        <p className="text-2xl font-mono uppercase tracking-[0.3em] text-primary/80 mb-4">Evolução individual</p>
        <h2 className="text-7xl font-bold mb-8">Quem cresceu, quem caiu</h2>
