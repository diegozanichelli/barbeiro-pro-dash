...
export type CycleStatus = "em_dia" | "renovacao_disponivel" | "vencido";

export interface CycleInfo {
  status: CycleStatus;
  /** Data prevista de vencimento (Date no fuso de Manaus, normalizada para meio-dia) */
  dueDate: Date;
  /** Dias até vencer. Negativo = vencido, 0 = vence hoje, positivo = ainda no prazo */
  daysLeft: number;
  /** Data formatada dd/MM/yyyy */
  dueDateLabel: string;
  /** Texto curto do estado (Ex: "Vence em 3 dias", "Vencida em 14/04") */
  label: string;
