        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              <FormField control={form.control} name="organizationName" render={({
              field
            }) => <FormItem>
              ...
              <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Após o período de teste, a assinatura será de R$ 197,00/mês. Você pode cancelar a qualquer momento.</p>
              </div>
