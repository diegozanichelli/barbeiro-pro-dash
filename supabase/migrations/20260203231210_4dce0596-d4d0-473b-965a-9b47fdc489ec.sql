-- Função atualizada para recalcular totais (suporta INSERT, UPDATE e DELETE)
...
DROP TRIGGER IF EXISTS sync_production_on_transaction_delete ON public.sale_transactions;

-- Criar trigger único para INSERT, UPDATE e DELETE
CREATE TRIGGER sync_production_on_transaction
