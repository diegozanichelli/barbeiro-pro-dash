-- 1. Create atomic RPC for sale + production in one transaction
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO sale_transactions (
      ...
      (p_date || ' 12:00:00')::timestamp AT TIME ZONE 'America/Manaus'
    );
  END LOOP;
...
-- 2. Fix link_orphan_transactions to use pure date comparison
...
-- 3. Rescue orphaned transactions
