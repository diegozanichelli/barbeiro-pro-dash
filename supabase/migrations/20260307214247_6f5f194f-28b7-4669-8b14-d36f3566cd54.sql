...
CREATE OR REPLACE FUNCTION public.create_sale_and_ensure_production(p_organization_id uuid, p_barber_id uuid DEFAULT NULL::uuid, p_date date DEFAULT CURRENT_DATE, p_transactions jsonb DEFAULT '[]'::jsonb, p_source text DEFAULT 'manager'::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
