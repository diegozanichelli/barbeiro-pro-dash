-- Force PL/pgSQL to prefer table columns over OUT parameters/variables on name conflicts.
-- This avoids intermittent "client_id is ambiguous" in RETURNS TABLE functions.
